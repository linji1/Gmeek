...
if os.environ.get('GITHUB_EVENT_NAME')!='schedule':
    ...
    workspace_path = os.environ.get('GITHUB_WORKSPACE')
    readme="<h1 tabindex='-1' class='heading-element' dir='auto'>当我离开这个世界后，希望这个网站还能存在100年。<div style='font-size: 12px;text-align: right;margin-top: -17px;'>2025.02.19</div></h1>\r\n"
